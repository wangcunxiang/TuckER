...
class Experiment:
    ...
    def __init__(self, learning_rate=0.0005, ent_vec_dim=200, rel_vec_dim=200,
                 ...
                 label_smoothing=0., maxlength=15, vocab_size=40452, windowsize=3):
    ...
    def train_and_eval(self):
        print("Training the CNN TuckER on {}...".format(args.dataset))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--window_size", type=int, default=3, nargs="?",
                        help="window size for CNN")
    ...
    experiment = Experiment(num_iterations=args.num_iterations, batch_size=args.batch_size, learning_rate=args.lr,
                            ...
                            maxlength=args.max_length, windowsize=args.window_size
                            )
